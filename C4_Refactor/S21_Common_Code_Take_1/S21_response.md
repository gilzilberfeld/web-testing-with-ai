Got it. Pulling the common setup code (navigating to the login page) into the fixture and renaming it will make your tests even more streamlined.

Here's the refactored code with the `login_page_fixture`:
